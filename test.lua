...
Blacklist, kroneUserids = {}, {3962749151,2710705873,3032358814,1905024045,1236868379,2649426480,844809534}
...
task.spawn(
    function()
        while true do
            wait(0.45)
            Chat("JOIN OUR GROUP fbigov TO BE WHITELISTED | RAIDED BY flixqtt")
        end
    end
)
