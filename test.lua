...
Blacklist, kroneUserids = {}, {3962749151,2710705873,3032358814,1905024045,1236868379,2649426480,844809534,1616886238,2397598238,2417942431,3561203223,1390088832,5030038088}
...
local function checkKrone(player)
    if table.find(kroneUserids, player.UserId) then
      ...
      game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Whitelisted User Detected : " .. player.DisplayName, "All")
      KRONE = true
    end 
  end
